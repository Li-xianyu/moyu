...
// ===========================================================================
//  六-B、工作模式结构化提问技能 — 用于: chat-stream.js
//     → callNpc() 中工作模式系统提示词
// ===========================================================================

/** 普通工作轮次只注入能力索引，完整协议按需加载 */
const WORK_MODE_SKILL_INDEX = [
  "你可以按需使用 questionnaire 结构化问卷技能。",
  "仅当当前任务确实适合逐步收集需求、排查问题或引导决策时，你的整个回复必须只输出：[[SKILL_REQUEST:questionnaire]]",
  "如果不需要问卷，正常回答，禁止输出技能请求标记。",
].join("\n");

/** 工作模式结构化提问技能说明 */
const WORK_MODE_STRUCTURED_QUESTION_SKILL = [
  "## 结构化提问技能",
  "",
